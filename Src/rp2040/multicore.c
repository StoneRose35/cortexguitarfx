...
{
    uint32_t * stackPtr = &__StackTopOne;
    stackPtr[0] = (uint32_t)secondMain;
    const uint32_t cmd_sequence[] = {0, 0, 1, (uintptr_t) &__vectors_core1, (uintptr_t) stackPtr, (uintptr_t)jumpIntoCore1Main};
