 ...
 */
irq_handler_t irq_get_exclusive_handler(uint32_t num);
 ...
 * \see irq_set_exclusive_handler()
 */
void irq_add_shared_handler(uint32_t num, irq_handler_t handler, uint8_t order_priority);
 ...
 * \see irq_add_shared_handler()
 */
void irq_remove_handler(uint32_t num, irq_handler_t handler);
 ...
 */
irq_handler_t irq_get_vtable_handler(uint32_t num);
 ...
 */
static inline void irq_clear(uint32_t int_num) {
